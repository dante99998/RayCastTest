...
class Game:
    ...
    def draw_background(self, display, *rect):
        ...
        gw = w
        gh = SCR_HEIGHT - gy
        pg.draw.rect(display, cc.SandyBrown, (gx, gy, gw, gh))
    ...
    def update_view(self, gmap, disp, player):
        self.draw_map(gmap, disp)
        self.draw_player(player, disp)
        self.draw_fov(player, disp, gmap)
    ...
    def event_handler(self):
        ...
        self.display.fill(cc.White)
        self.update_view(self.map, self.display, self.player)
